import sys
from PyQt6.QtWidgets import QApplication, QWidget, QFormLayout, QGridLayout, QTabWidget, QLineEdit, QDateEdit, \
    QPushButton
...
class MainWindow(QWidget):
    def __init__(self, *args, **kwargs):
        ...
        # create a tab widget
        tab = QTabWidget(self, movable=True, tabShape=QTabWidget.TabShape.Triangular,
                         tabPosition=QTabWidget.TabPosition.North)
        # For closing tabs: , tabsClosable=True
